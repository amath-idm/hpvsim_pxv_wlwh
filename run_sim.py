...
if __name__ == '__main__':
    ...
    hiv_datafile = [f'data/hiv_incidence_south_africa_sens.csv',
                    f'data/south_africa_female_hiv_mortality.csv',
                    f'data/south_africa_male_hiv_mortality.csv']
    art_datafile = [f'data/art_coverage_south_africa.csv']
