...
if __name__ == '__main__':
    ...
    pars = {
        ...
        'hiv_pars' : {'model_hiv_death': False,
                      'rel_sus':dict(lt200=1,gt200=1),
                      'rel_sev':dict(lt200=1,gt200=1),
                      'rel_imm':dict(lt200=1,gt200=1)}
    }
    ...
    rsa_df = pd.read_csv(f'data/RSA_data.csv').set_index('Unnamed: 0').T
